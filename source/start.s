...
.global PAYLOAD_TEXTADDR
.global PAYLOAD_TEXTEND
.global PAYLOAD_TEXTMAXSIZE
...
.space ((_start + 0x1000) - .) @ Pad to otherapp payload start.
PAYLOAD_TEXTADDR:
.space 0x10000 @ More than what's needed at the time of writing, but whatever.
PAYLOAD_TEXTEND:
.word 0

PAYLOAD_TEXTMAXSIZE:
.word (PAYLOAD_TEXTEND - PAYLOAD_TEXTADDR)
